...
export function MyProjects() {
  const projects = [
    {
      title: "RVM",
      tools: "Ptyhon, Embedded Kit RassperyPI, Flutter",
      description: "(Graduation A device that accepts used bottles or cans and gives rewards or refunds in return for recycling them.",
      icon: "♻️",
      color: "black",
      demo: "https://github.com/abdelrahman499/EARN-BY-RETURN",
    },
    {
      title: "E-Commerce ",
      tools: "JS, HTML5/CSS3, Bootstrap",
      description: "E-commerce frontend app using only client-side storage, authentication, product management, and cart functionality.",
      icon: "🛍️",
      color: "black",
      demo: "https://github.com/abdelrahman499/E-Commerce-Front",
    },
    {
      title: "Examination System",
      tools: "EF Core, Linq, MS SQL,Windows Forms",
      description: "A desktop application that manages exams, questions, and student results through an easy-to-use graphical interface.",
      icon: "📝",
      color: "black",
      demo: "https://github.com/abdelrahman499/Examination-Systme-WindowsForms",
    },
    
    {
      title: "Breaking Out Game",
      tools: "Python, OpenGL, Pygame",
      description: "A Breaking Out game built with Python and OpenGL, featuring interactive paddle-and-ball gameplay",
      icon: "🕹️",
      color: "black",
      demo: "https://github.com/abdelrahman499/Breaking_Out_Game",
    },
  ];
