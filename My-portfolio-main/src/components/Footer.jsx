  ...
  return (
    <div className="bg-black ">
      ...
      <div className="text-white flex justify-center gap-6 py-4">
        <a
          href="https://drive.google.com/file/d/1P0fvcih0z3LmtBt-RN0AYVV6iJaU_7Ut/view?usp=sharing"
          target="_blank"
        ...
        <a
          href="https://github.com/abdelrahman499"
          target="_blank"
        ...
        <a
          href="https://www.linkedin.com/in/abdelrahman-ramadan-elqatcha/"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:scale-125 transition-colors"
        >
        ...
        <a
          href="https://wa.me/qr/DED3FHLVAO7KE1"
          target="_blank"
          className="hover:scale-125 transition-colors"
        >
          <Smartphone size={32} />
